    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
            ...
            <ul className="flex items-center">
              ...
              <li>
                <a
                  ...
                  href="resume.pdf" download="UmangP_Resume.pdf"
                >
                Resume
                </a>
              </li>
          ...
          <div className="text-center justify-auto p-10 py-10">
            <h2 className="text-5xl py-2 text-teal-600 font-medium dark:text-teal-400 md:text-6xl">
              Umang Patel
            </h2>
            <h3 className="text-center text-2xl py-2 dark:text-white md:text-3xl">
        ...
        <section>
          <div>
            <h3 className="text-3xl py-1 dark:text-white ">"INFO"</h3>
